...
Remember, the quizzes should only include facts the assistant is aware of.

Output an explanation of whether the quiz only references information in the context. Make the explanation brief
only include a summary of your reasoning for the decsion. Include a clear "Yes" or "No" as the first paragraph.
...
def report_evals():
  ...
  for row in dataset:
    ...
    eval_response = model_graded_evaluator.invoke({"context": quiz_information_bank, "agent_response": answer})
